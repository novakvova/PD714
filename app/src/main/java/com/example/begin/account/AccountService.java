...
public class AccountService {
    ...
    private static final String BASE_URL = "https://apppeter.azurewebsites.net/api/account/";//"http://10.0.2.2/api/account/";//"https://autobazar.azurewebsites.net/api/account/";
